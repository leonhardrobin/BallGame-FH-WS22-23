...
DECLARE_DYNAMIC_MULTICAST_DELEGATE(FBallThrown);
...
public: 
	...
	/** The maximum time to scale the shooting force in seconds. */
...
private:
	...
	/** When the player shoots a ball, this will be called */
	UPROPERTY(BlueprintAssignable)
	FBallThrown OnBallThrown;
};
